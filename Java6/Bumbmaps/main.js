...
const earthTexture = textureLoader.load('rivers_diff.jpg');
const earthNormalMap = textureLoader.load('river_nor.exr');
const displacementMAp=textureLoader.load('river_disp_4k.png');
